...
namespace INeedHelp.Client.Views
{
    ...
    /// </summary>
    public sealed partial class SearchRequestsView : INeedHelp.Client.Common.LayoutAwarePage
    {
        public SearchRequestsView()
        {
        ...
        {
            var text = navigationParameter.ToString();
            (DataContext as SearchRequestsViewModel).SearchLoaded.Execute(text);
        }
